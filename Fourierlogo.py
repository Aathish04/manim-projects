...
#Made by Grant/3Blue1Brown. Found in 
#https://github.com/3b1b/manim/blob/master/from_3b1b/active/diffyq/part2/fourier_series.py and condensed
#to allow for easy Fourier Series to be made in Manim. You determine the shape in the get_shape() function
#Can take a Mobject or SVG
class Fourier(Scene):
    CONFIG = {
        "start_drawn": True,
        "center_point": ORIGIN,
    ...
    def construct(self):
        print("Started")
        shape = SVGMobject("/Users/aathishs/Desktop/desmos-graph_1.svg")
    ...
    # def get_shape(self):
    #     path = VMobject()
    #     shape = Text("MANIM", font="Handwriting").scale(0.5)
